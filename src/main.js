...
,
        ...
        mode: 'payment',
        success_url: `https://dog-homeschool.web.app/payment-success/${id}?session_id={CHECKOUT_SESSION_ID}`,
        cancel_url: `https://dog-homeschool.web.app/payment-cancel/${id}?session_id={CHECKOUT_SESSION_ID}`,
      });
